 ...
 */
final class Version20180919052302 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE realty (id INT NOT NULL, manager_id INT DEFAULT NULL, realty INT NOT NULL, updated_user_id INT NOT NULL, category VARCHAR(255) NOT NULL, area NUMERIC(5, 2) DEFAULT NULL, price NUMERIC(10, 2) DEFAULT NULL, description JSONB DEFAULT NULL, status VARCHAR(255) NOT NULL, cadastral_number VARCHAR(255) DEFAULT NULL, fee NUMERIC(6, 2) DEFAULT NULL, exclusive BOOLEAN DEFAULT \'false\' NOT NULL, hidden_info JSONB DEFAULT NULL, rooms SMALLINT DEFAULT NULL, floor SMALLINT DEFAULT NULL, owner JSONB NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
