 ...
 */
final class Version20180831050836 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE address (id INT NOT NULL, street VARCHAR(255) NOT NULL, number VARCHAR(255) NOT NULL, district VARCHAR(255) NOT NULL, name VARCHAR(255) DEFAULT NULL, type VARCHAR(255) DEFAULT NULL, developer VARCHAR(255) DEFAULT NULL, new_building BOOLEAN DEFAULT \'false\' NOT NULL, year INT DEFAULT NULL, floors INT DEFAULT NULL, description JSON DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE realty (id INT NOT NULL, manager_id INT DEFAULT NULL, address_id INT NOT NULL, category VARCHAR(255) NOT NULL, area INT DEFAULT NULL, price INT DEFAULT NULL, description JSON DEFAULT NULL, status VARCHAR(255) NOT NULL, cadastral_number VARCHAR(255) DEFAULT NULL, fee INT DEFAULT NULL, exclusive BOOLEAN DEFAULT \'false\' NOT NULL, hidden_info JSON DEFAULT NULL, rooms INT DEFAULT NULL, floor INT DEFAULT NULL, owner JSON NOT NULL, PRIMARY KEY(id))');
